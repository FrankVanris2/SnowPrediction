...
| R3 | The system should provide a web interface for users | N/A | N/A | Component: React Web Server |  
| R4 | The system should allow users to search for specific information, regarding Snoqualmie Pass | N/A | N/A | Component: User Interaction |
| R5 | The system should display snowfall predictions for the next day when users click the Get Forecast button | N/A | N/A | Component: User Interaction |
| R6 | The system should display possible snow accumulation amounts when snow is predicted | N/A | N/A | Component: User Interaction |
